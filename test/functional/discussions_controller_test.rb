...
class DiscussionsControllerTest < ActionController::TestCase
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post :create, discussion: { message: @discussion.message, t: @discussion.t, topic: @discussion.topic, user: @discussion.user }
    end
  ...
  test "should update discussion" do
    put :update, id: @discussion, discussion: { message: @discussion.message, t: @discussion.t, topic: @discussion.topic, user: @discussion.user }
    assert_redirected_to discussion_path(assigns(:discussion))
  end
